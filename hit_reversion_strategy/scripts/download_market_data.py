...
single Parquet file under::
    ...
    data/raw/downloaded_market_logs/

Examples
--------
Download the default rolling window::

    .venv/bin/python scripts/download_market_data.py

Smoke-test two games without reusing cached trades::

    .venv/bin/python scripts/download_market_data.py --max-games 2 --refresh-trades --verbose

Download a fixed, reproducible game-date window (both dates inclusive)::

    .venv/bin/python scripts/download_market_data.py --start-date 2026-05-15 --end-date 2026-07-12
"""
...
DEFAULT_OUTPUT_DIR = REPOSITORY_ROOT / "data/raw/downloaded_market_logs"
