...
PITCH_STATE_PATH = (
    REPOSITORY_ROOT / "data/processed/mlb_game_state/pitch_state_features.parquet"
)
MLB_CACHE_DIR = REPOSITORY_ROOT / "data/raw/mlb_timestamps/cache/2026"
RAW_TRADE_PATH = REPOSITORY_ROOT / "data/shared/home_market_trades.parquet"
TRAIN_PATH = REPOSITORY_ROOT / "data/hit_reversion/training_dataset.parquet"
TEST_PATH = REPOSITORY_ROOT / "data/hit_reversion/test_dataset.parquet"
MODEL_PATH = (
    PROJECT_ROOT / "models/local_win_expectancy.cbm"
)
OUTPUT_DIR = REPOSITORY_ROOT / "data/shared"
...
def main() -> None:
    ...
    trades = pd.read_parquet(RAW_TRADE_PATH)
    print(
